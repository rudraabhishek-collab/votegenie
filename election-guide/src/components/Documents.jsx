...
export default function Documents({ dark }) {
  return (
    <section id="documents" className="scroll-mt-20" aria-labelledby="docs-h">
      <SectionHeader tag="Documents" title="What you'll need"
        subtitle="Requirements vary by region. Confirm with your local authority." dark={dark} />
