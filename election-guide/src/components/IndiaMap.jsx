    ...
    <section id="indiamap" className="scroll-mt-20">
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        ...
        <div className={`relative flex-1 rounded-2xl border overflow-hidden shadow-card
          ...
          <div className={`absolute top-3 left-3 z-20 rounded-xl px-3 py-2.5 border shadow-xl backdrop-blur-sm
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="flex items-center gap-2 pt-1.5 mt-1 border-t border-slate-200 dark:border-white/15">
                ...
                <span className={`text-[0.65rem] font-bold ${dark ? 'text-white' : 'text-slate-700'}`}>Selected</span>
              </div>
            </div>
          </div>
          ...
          <p className={`text-center text-[0.62rem] py-2 px-4 ${dark ? 'text-slate-700' : 'text-slate-700'}`}>
        ...
        <div className="lg:w-72 w-full flex flex-col gap-3">
          ...
          {selectedData ? (
              ...
              <div className="p-5">
                ...
                {[
                  ...
                  <div key={row.label}
                    ...
                    <div className="min-w-0">
                      <p className={`text-[0.62rem] font-extrabold uppercase tracking-widest ${dark ? 'text-white' : 'text-slate-700'}`}>{row.label}</p>
            ...
            <div className={`rounded-2xl border p-6 text-center ${dark ? 'bg-gray-900 border-[#283593]/40' : 'bg-white border-[#1a237e]/15'}`}>
              ...
              <p className={`text-[0.82rem] leading-relaxed ${dark ? 'text-white' : 'text-slate-700'}`}>
                {isHindi
              ...
              <div className={`mt-4 rounded-xl p-3 text-left ${dark ? 'bg-white/5' : 'bg-[#f0f4ff]'}`}>
                <p className={`text-[0.65rem] font-extrabold uppercase tracking-widest mb-2 ${dark ? 'text-white' : 'text-slate-700'}`}>Party Colors</p>
                  ...
                  {uniqueParties.slice(0, 8).map(party => {
                    ...
                    return (
                      <div key={party} className="flex items-center gap-1.5">
                        ...
                        <span className={`text-[0.68rem] font-semibold ${dark ? 'text-white' : 'text-slate-700'}`}>{party}</span>
                      </div>
                    )
                  })}
                </div>
          ...
          <div className={`rounded-2xl border p-4 ${dark ? 'bg-[#0d1757]/60 border-[#283593]/40' : 'bg-[#e8eaf6] border-[#1a237e]/15'}`}>
            <p className={`text-[0.65rem] font-extrabold uppercase tracking-widest mb-3 ${dark ? 'text-white' : 'text-slate-700'}`}>India at a Glance</p>
            {[
              ...
              <div key={s.label} className={`flex justify-between items-center py-1.5 border-b last:border-0 ${dark ? 'border-white/[0.05]' : 'border-[#1a237e]/10'}`}>
                <span className={`text-[0.78rem] flex items-center gap-1.5 ${dark ? 'text-white' : 'text-slate-700'}`}>
          ...
          <p className={`text-[0.65rem] text-center ${dark ? 'text-slate-700' : 'text-slate-700'}`}>
